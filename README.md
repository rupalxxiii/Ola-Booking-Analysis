...
This project is an end-to-end Data Analytics Dashboard built using SQL, Power BI, and Excel/CSV datasets to analyze ride booking data for an OLA-like cab service platform.
